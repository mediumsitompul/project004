...
import 'login_success_it_1.dart';
import 'login_success_hr_2.dart';
import 'login_success_finance_3.dart';
...
class _MyProject001State extends State<MyProject001> {
  ...
  Future<void> _login() async{
    ...
    if(datauser !=""){
      ...
      if(datauser[0]['c_profile']=='p-01'){
        Navigator.push(context, MaterialPageRoute(builder: (context)=>MyApp1()));
      }
      else if(datauser[0]['c_profile']=='p-02'){
        Navigator.push(context, MaterialPageRoute(builder: (context)=>MyApp2()));
      }
      else if(datauser[0]['c_profile']=='p-03'){
